...
const card2= () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    navigate('/card3'); // Make sure you have a route set up for AnotherComponent
  };
  ...
  return (
    ...
    <div>
    <h1 style={{color:'Blue'}}>Confirm Transaction Page</h1>
    <form onSubmit={handleFormSubmit}>
        ...
        <button type="submit" style={{color:'blue'}}>Confirm</button>
        </div>
      </form>
    </div>
    </Card>
