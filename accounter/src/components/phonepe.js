...
const phonepe = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    navigate('/phonepe2'); // Make sure you have a route set up for AnotherComponent
  };


  return (
    <div style={{padding:50,height:550,backgroundColor:"beige"}}>
      <h1 style={{color:'purple'}}>Welcome to the Transaction through PhonePe</h1>
    ...
    <div className="form-container">
      <h3>Fill the Appropriate Details Below</h3>
      <form onSubmit={handleFormSubmit}>
        ...
        <button type="submit" style={{color:"purple"}}>Login</button>
        </div>
      </form>
    </div>
    </Card>
