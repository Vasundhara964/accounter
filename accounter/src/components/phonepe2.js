...
const phonepe2= () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    navigate('/phonepe3'); // Make sure you have a route set up for AnotherComponent
  };
  ...
  return (
    ...
    <div>
    <h1 style={{color:'purple'}}>Confirm Transaction Page</h1>
    <form onSubmit={handleFormSubmit}>
        ...
        <button type="submit" style={{color:'purple'}}>Confirm</button>
        </div>
      </form>
    </div>
    </Card>
